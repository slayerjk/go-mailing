...
// form report from log file(get string by reading file)
...
// send plain text mail report using your log file
func SendReport(
	...
	// send mail
	err = SendEmailWoAuth("plain", mailHost, mailPort, mailFrom, mailSubject, reportBody, adminsList, nil)
	if err != nil {
